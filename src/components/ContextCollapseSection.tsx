        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((problem, index) => (
            <motion.div
              ...
              className="bg-[#0a0a0a] border border-[#333] p-8 rounded-xl flex flex-col items-start hover:border-gray-600 transition-colors"
            >
              <div className="w-12 h-12 rounded-lg bg-[#111] border border-[#333] flex items-center justify-center text-gray-300 mb-6">
                {problem.icon}
              </div>
